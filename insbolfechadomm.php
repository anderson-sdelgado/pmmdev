...
require('./dao/InsBolFechadoMMDAO.class.php');
require('./dao/InserirDadosDAO.class.php');

$insBolFechadoMMDAO = new InsBolFechadoMMDAO();
...
if (isset($info)):
    ...
    $dados = $info['dado'];
    $inserirDadosDAO->salvarDados($dados, "insfechadomm");
    ...
    echo $insBolFechadoMMDAO->salvarDados($dadosBoletim, $dadosAponta, $dadosImplemento, $dadosRendimento, $dadosApontaAplicFert, $dadosRecolMang);
