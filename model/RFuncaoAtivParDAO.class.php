    ...
    public function dados() {
        ...
        $select = " SELECT " 
                    ...
                    . " FROM "
                        . " (SELECT " 
                        . " A.ATIVAGR_ID "
                        . " , CASE WHEN A.INFO_REND = 1 THEN 1 END AS FLAGRENDIMENTO "
                    ...
                    . " SELECT "
                        ...
                        . " , 'FLAGCALIBPNEU', 3, 'FLAGTROCAMOTORISTA', 4, 'FLAGDESENGATEENGATE', 5) AS \"codFuncao\" "
                        . " , 2 AS \"tipoFuncao\" "
                    . " FROM "
                        . " (SELECT " 
                        . " MOTPARADA_ID "
...
//                        . " , DECODE(CD, 66, 1) AS FLAGCALIBPNEU "
                        . " , DECODE(CD, 0, 1) AS FLAGCALIBPNEU "
                        . " , DECODE(MOTPARADA_ID, 193, 1) AS FLAGTROCAMOTORISTA "
                        . " , DECODE(MOTPARADA_ID, 70, 1) AS FLAGDESENGATEENGATE "
                        . " FROM "
