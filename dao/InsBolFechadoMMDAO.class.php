                    ...
                    if ($bol->idBoletim == $apont->idBolAponta) {
                        ...
                        if ($v == 0) {
                            ...
                            $this->Create = $this->Conn->prepare("begin "
                                    . " pkb_pmm_apontamento({$idBoletim}, {$apont->osAponta}"
                            ...
                            if (!isset($idApont) || empty($idApont)) {
...
//                                                    . " PMM_APONTAMENTO "
//                                                    . " WHERE "
//                                                    . " DTHR = (TO_DATE('" . $apont->dthrAponta . "','DD/MM/YYYY HH24:MI')  - (1 / 24))"
//                                                    . " AND "
...
//                                            $this->Read->setFetchMode(PDO::FETCH_ASSOC);
//                                            $this->Read->execute();
//                                            $res50 = $this->Read->fetchAll();
//
//                                            foreach ($res50 as $item50) {
//                                                $idApont = $item50['ID'];
//                                            }
//                                        }
...
//                                            $this->Read->setFetchMode(PDO::FETCH_ASSOC);
//                                            $this->Read->execute();
//                                            $res51 = $this->Read->fetchAll();
//
//                                            foreach ($res51 as $item51) {
//                                                $idApont = $item51['ID'];
//                                            }
//                                        }
                    ...
                    if ($bol->idBoletim == $rend->idBolRendimento) {
                        ...
                        if (!isset($rend->dthrRendimento) || empty($rend->dthrRendimento)) {
                            ...
                            $select = " SELECT "
                                    ...
                                    . " AND "
                                    . " DTHR = TO_DATE('" . $rend->dthrRendimento . "','DD/MM/YYYY HH24:MI') "
                                    . " AND "
                                    . " BOLETIM_ID = " . $idBoletim;
                ...
                foreach ($dadosAponta as $apont) {
                    ...
                    if ($bol->idBoletim == $apont->idBolAponta) {
                        ...
                        if ($v == 0) {
                            ...
                            $this->Create = $this->Conn->prepare("begin "
                                    . " pkb_pmm_apontamento({$idBol}, {$apont->osAponta}"
                                    . " , {$apont->atividadeAponta}, {$apont->paradaAponta} "
                                    . " , {$apont->transbordoAponta}, '{$apont->dthrAponta }'); "
                                    . " end;");
                            $this->Create->execute();
...
//                                            $this->Read->setFetchMode(PDO::FETCH_ASSOC);
//                                            $this->Read->execute();
//                                            $res53 = $this->Read->fetchAll();
//
//                                            foreach ($res53 as $item53) {
//                                                $idApont = $item53['ID'];
//                                            }
//                                        }
...
//                                            $this->Read->setFetchMode(PDO::FETCH_ASSOC);
//                                            $this->Read->execute();
//                                            $res54 = $this->Read->fetchAll();
//
//                                            foreach ($res54 as $item54) {
//                                                $idApont = $item54['ID'];
//                                            }
//                                        }
